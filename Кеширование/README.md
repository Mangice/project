...
- Изменил немного команду TTL поставил больше, потому что при значении 5, оно слишком быстро удаляется. Принцип тот же, но с большим значением. Понимаю, что правильная команда `set key1 0 5 5`, пременил значение для удобства. Так же число байт увеличил на 1, чтобы было более удобночитаемо.
